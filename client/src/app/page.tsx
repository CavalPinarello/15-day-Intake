      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            ...
            Complete your comprehensive 10-day sleep journey with personalized assessments.
          </p>
          <Link 
            href="/journey"
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">10-Day Journey</h3>
            <p className="text-gray-600">
              Structured daily assessments spread over 10 days to capture your complete sleep profile without overwhelming you.
            </p>
          </div>
