...
const stageConfig = [
  { id: 1, title: "Data collected", icon: CheckCircle2, description: "15 days of sleep data ready" },
      ...
      {phase === "intake" && (
        <div className="bg-blue-500/10 rounded-lg p-3 mb-4">
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="text-sm text-blue-400 font-medium">15-Day Data Collection</p>
