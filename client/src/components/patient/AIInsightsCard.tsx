...
export function AIInsightsCard({
  ...
  return (
    <BentoCard
      title="AI Insights"
      subtitle={lastAnalysisTime ? `Last analyzed ${lastAnalysisTime}` : selectedModel ? `${selectedModel}${modelProvider ? ` (${modelProvider})` : ''}` : "AI analysis"}
      size="medium"
      icon={
        <svg
          className="w-4 h-4"
