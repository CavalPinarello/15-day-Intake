...
struct AnalysisStage: Identifiable, Equatable {
    ...
    static let stages: [AnalysisStage] = [
        AnalysisStage(id: 1, title: "Data collected", description: "Your 10 days of sleep data are ready for analysis", icon: "checkmark.circle.fill", isComplete: false, isCurrent: false),
